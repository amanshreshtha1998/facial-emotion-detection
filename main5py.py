...
#%%
emotions = ["anger", "happy", "sad","surprise", "fear"] #Emotion list
...
data_direc = 'F:/year 2/udyam/mosaic/this_will_work/dataset/5_emotions/'
...
#%%
filename = 'F:/year 2/udyam/mosaic/this_will_work/classifiers/good5.pkl'
